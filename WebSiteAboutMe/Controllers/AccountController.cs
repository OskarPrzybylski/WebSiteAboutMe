            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await UserManager.SendEmailAsync(user.Id,
                       "Confirm your account", "Uzytkownik " + user.Email + " prosi o dostęp do bloga i wszystkich " +
                       "jego plusów. Swoją chęć dostania dostępu argumentuje: " + model.Argumentation + ". Aby zatwierdzić tego użytkownika kliknij: " +
                       " <a href=\""
                       + callbackUrl + "\">tutaj</a>");
