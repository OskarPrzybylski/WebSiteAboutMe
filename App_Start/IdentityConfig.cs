...
namespace WebSiteAboutMe
{
    public class EmailService : IIdentityMessageService
    {
        ...
        private async Task ConfigSendGridasync(IdentityMessage message)
        {
            ...
            messagee.From = fromAddress;
            messagee.Subject = "Akceptacja nowego użytkownika";
            messagee.IsBodyHtml = true;
            messagee.Body = message.Body;
            messagee.To.Add("przybylski.oskar@gmail.com");

            try
            {
                await smtpClient.SendMailAsync(messagee);
            }
            catch (Exception ex)
            {
